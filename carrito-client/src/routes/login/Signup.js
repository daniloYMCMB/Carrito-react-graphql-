        ...
        <div>
            <div style={styles.box}>
                ...
                <Form onSubmit={(ev)=>handleSubmit(ev, args)}>
                    ...
                    <Form.Field>
                        <Form.Input name="fullname" onChange={handleChange} placeholder="nombre de usuario" icon={<Icon name="remove circle" color="red" size="large" />} />
                    </Form.Field>
                    <Form.Field>
                    ...
                    <Button type="submit" primary fluid>Regístrate</Button>
                </Form>
            </div>
            <div style={styles.box}>
                ¿Tienes una cuenta? <div onClick={handleClick}>Inicia sesión</div>
            </div>
        </div>
    )
}